    ...
    <main className="fortune-app">
      ...
      <section className={`fortune-section fortune-result ${step === 6 ? "active" : ""}`}>
        ...
        <section className="fortune-share-panel" aria-label="공유 옵션">
          ...
          <div className="fortune-share-panel-grid">
            <button className="fortune-btn-share" type="button" onClick={shareViaKakao}>
              카카오톡
            </button>
            <button className="fortune-btn-share" type="button" onClick={shareViaTwitter}>
              X(Twitter)
            </button>
            <button className="fortune-btn-share" type="button" onClick={shareViaInstagram}>
              인스타그램
            </button>
            <button className="fortune-btn-share" type="button" onClick={shareViaMessage}>
              메시지
            </button>
            <button className="fortune-btn-share" type="button" onClick={() => saveShareImage()}>
              🖼️ 이미지 저장
            </button>
            <button className="fortune-btn-share" type="button" onClick={shareToSocialMedia}>
              시스템 공유
            </button>
            <button className="fortune-btn-share" type="button" onClick={() => copyText(getSharePayload().shareUrl, "링크를 복사했어요.")}>
              🔗 링크 복사
            </button>
          </div>
        </section>
